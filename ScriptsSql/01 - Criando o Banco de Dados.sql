...
/****** Object:  Database [BS]    Script Date: 01/06/2022 20:10:35 ******/
CREATE DATABASE [BS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BS', FILENAME = N'C:\DBDATA\Banco_Sangue\BS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BS_log', FILENAME = N'C:\DBDATA\Banco_Sangue\BS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [BS] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [BS] SET  DISABLE_BROKER 
GO
